...
const COLOR_MAP = {
  violet:  { bg: '#f3f0ff', border: '#ddd6fe', text: '#6d28d9', dot: '#8b5cf6' },
  blue:    { bg: '#eff6ff', border: '#bfdbfe', text: '#1d4ed8', dot: '#3b82f6' },
  emerald: { bg: '#ecfdf5', border: '#6ee7b7', text: '#065f46', dot: '#10b981' },
  ...
  return (
    <svg ref={svgRef} viewBox="0 0 300 220" fill="none"
      ...
      <text x="150" y="210" textAnchor="middle" fontSize="10"
        fill="#d1d5db" fontFamily="monospace">bubble sort — step 4 of 12</text>
    </svg>
  )
}
...
function Landing() {
  ...
  return (
    <div ref={pageRef} style={{ minHeight: '100vh', background: '#fff', fontFamily: "'Outfit','Segoe UI',sans-serif" }}>
      <Navbar />
      ...
      <section style={{
        ...
        {/* Left */}
        <div style={{ padding: '64px 48px 64px 72px' }}>
          ...
          <h1 className="hero-stagger" style={{
            ...
            lineHeight: 1.13, letterSpacing: '-0.03em', color: '#111827', marginBottom: 16,
          ...
          <p className="hero-stagger" style={{ fontSize: 16, color: '#6b7280', lineHeight: 1.75, marginBottom: 34, maxWidth: 380 }}>
          ...
          <div className="hero-stagger" style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            ...
            <button onClick={() => navigate('/compare')}
              ...
              onMouseEnter={e => { e.currentTarget.style.borderColor='#c4b5fd'; e.currentTarget.style.color='#7c3aed'; e.currentTarget.style.background='#f3f0ff' }}
          ...
          <div className="hero-stagger" style={{ display: 'flex', gap: 32, marginTop: 44 }}>
        ...
        <div style={{
          ...
          background: 'linear-gradient(140deg,#faf5ff 0%,#f5f3ff 55%,#ecfdf5 100%)',
          minHeight: 'calc(100vh - 64px)',
        }}>
          <div style={{
            background: '#fff', borderRadius: 24, padding: '28px 24px',
            boxShadow: '0 8px 40px rgba(124,58,237,0.10),0 1px 3px rgba(0,0,0,0.05)',
            border: '1px solid #ede9fe', width: '100%', maxWidth: 360,
          }}>
      ...
      <section className="scroll-reveal" style={{
        padding: '0', borderTop: '1px solid #f3f4f6', borderBottom: '1px solid #f3f4f6',
        ...
        <div style={{ display: 'flex', alignItems: 'stretch' }}>
          {[['12+','Algorithms','#7c3aed'],['3','Data Structures','#10b981'],['2','Languages','#3b82f6']].map(([v,l,c], i) => (
            <div key={l} style={{
              ...
              <p style={{ fontSize: 13, color: '#9ca3af', marginTop: 4, marginBottom: 0 }}>{l}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* ── FEATURES ─────────────────────────────────────────────── */}
      <section className="scroll-reveal" style={{ padding: '96px 24px', background: '#fff' }}>
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          {/* Label */}
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 14 }}>
            <div style={{ height: 1, width: 40, background: '#e5e7eb' }} />
            <span style={{ fontSize: 11, fontWeight: 700, color: '#9ca3af', letterSpacing: '0.1em', textTransform: 'uppercase' }}>Why StepWise</span>
            <div style={{ height: 1, width: 40, background: '#e5e7eb' }} />
          </div>
          <h2 style={{
            fontSize: 28, fontWeight: 700, color: '#111827', textAlign: 'center', marginBottom: 56,
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(280px,1fr))', gap: 24 }}>
            {FEATURES.map(({ icon, title, desc, accent, accentBg, accentBorder }) => (
              <div key={title} style={{
                ...
                onMouseEnter={e => { e.currentTarget.style.transform='translateY(-4px)'; e.currentTarget.style.boxShadow=`0 12px 32px ${accent}22` }}
              ...
              >
                <div style={{
                  ...
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  marginBottom: 20, boxShadow: `0 2px 8px ${accent}18`,
                }}>
                  {icon}
                </div>
                <h3 style={{ fontWeight: 700, color: '#111827', fontSize: 17, marginBottom: 10 }}>{title}</h3>
      ...
      <section className="scroll-reveal" style={{
        ...
        <div style={{ maxWidth: 1000, margin: '0 auto', textAlign: 'center' }}>
          <div style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:8, marginBottom:14 }}>
            <div style={{ height:1, width:40, background:'#e5e7eb' }} />
            <span style={{ fontSize:11, fontWeight:700, color:'#9ca3af', letterSpacing:'0.1em', textTransform:'uppercase' }}>Explore</span>
            <div style={{ height:1, width:40, background:'#e5e7eb' }} />
          </div>
          <h2 style={{
      ...
      {/* ── ROADMAP ──────────────────────────────────────────────── */}
      <section className="scroll-reveal" style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #f3f4f6' }}>
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <p style={{ fontSize: 14, color: '#9ca3af' }}>StepWise is actively being built — here's what's on the horizon</p>
          </div>
            ...
            {COMING_SOON.map(({ icon, title, desc }) => (
              <div key={title}
                style={{
                  ...
                  background:'#fff', transition:'border-color 0.18s, background 0.18s, transform 0.18s',
                }}
                onMouseEnter={e => {
              ...
              >
                ...
                <div>
                  <h3 style={{ fontWeight:700, color:'#111827', fontSize:14, marginBottom:5 }}>{title}</h3>
      ...
      {/* ── CTA ──────────────────────────────────────────────────── */}
      <section className="scroll-reveal" style={{ padding: '80px 24px', background: '#fafafa', borderTop: '1px solid #f3f4f6' }}>
        <div style={{
      ...
      <footer style={{ borderTop: '1px solid #f3f4f6', background: '#fff' }}>
        ...
        <div style={{
          ...
          <div style={{ maxWidth: 260 }}>
            <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:10 }}>
              ...
              <span style={{ fontWeight:700, fontSize:16, color:'#111827', letterSpacing:'-0.01em' }}>StepWise</span>
            </div>
          ...
          {/* Quick links */}
          <div>
            <p style={{ fontSize:11, fontWeight:700, color:'#d1d5db', letterSpacing:'0.08em', textTransform:'uppercase', marginBottom:12 }}>Explore</p>
            {[['Visualizer','/visualize'],['Compare','/compare']].map(([label, path]) => (
              <div key={label}
                onClick={() => navigate(path)}
                style={{
                  fontSize:14, color:'#6b7280', marginBottom:8, cursor:'pointer',
          ...
          <div style={{
            ...
            <p style={{ fontSize:11, fontWeight:700, color:'#c4b5fd', letterSpacing:'0.08em', textTransform:'uppercase', marginBottom:12 }}>Developer</p>
            <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:14 }}>
              ...
              <div>
                <div style={{ fontWeight:700, color:'#111827', fontSize:14 }}>Adarsh Srivastava</div>
                <div style={{ fontSize:12, color:'#9ca3af' }}>Software Developer</div>
              </div>
            </div>
            <a href="https://adarsh3e8.in" target="_blank" rel="noopener noreferrer"
              style={{
                display:'inline-flex', alignItems:'center', gap:6,
        ...
        <div style={{
          ...
          <p style={{ fontSize:12, color:'#d1d5db', margin:0 }}>
            © {new Date().getFullYear()} StepWise — built to make algorithms click
          </p>
          <p style={{ fontSize:12, color:'#d1d5db', margin:0 }}>
            Made with ♥ by{' '}
            <a href="https://adarsh3e8.in" target="_blank" rel="noopener noreferrer"

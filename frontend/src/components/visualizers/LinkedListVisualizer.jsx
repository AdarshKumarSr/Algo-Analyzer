  ...
  return (
    <div className="bg-white rounded-xl border border-zinc-200 p-6 mb-4">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <span className="text-gray-400 text-sm">{getDescription()}</span>
      </div>
      ...
      <div className="flex items-center gap-1 overflow-x-auto pb-2 mb-8">
        ...
        {nodes.length === 0 ? (
          <span className="text-zinc-400 text-sm font-mono">Empty list</span>
        ) : (
          nodes.map((val, idx) => {
          ...
          <table className="text-sm font-mono border border-zinc-200 rounded-lg overflow-hidden">
            ...
            <tbody>
              <tr className="text-center">
                <td className="px-6 py-2 border-r border-zinc-200 text-yellow-600 font-bold">
                  {nodes[current]}
                </td>

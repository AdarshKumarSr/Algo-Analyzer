function StackVisualizer({ step }) {
  ...
  const { stack, top, pushing = null, popping = null, popped = null, peeking = null } = step.state
    ...
    <div className="bg-white rounded-lg p-6 mb-4">
      ...
      {popped !== null && (
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="px-3 py-1 rounded-lg bg-red-50 border border-red-200 text-red-500 font-mono font-bold text-sm">
            {popped}
          </span>
        </div>
      )}
      ...
      {peeking !== null && (
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="px-3 py-1 rounded-lg bg-yellow-50 border border-yellow-200 text-yellow-600 font-mono font-bold text-sm">
            {peeking}
          </span>
        </div>
      )}

function SearchVisualizer({ step, slug }) {
  ...
  return (
    <div className="bg-white rounded-lg border border-zinc-100 p-6 mb-4">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <span className="px-3 py-1 rounded-lg bg-violet-50 border border-violet-200 text-violet-600 font-mono font-bold text-sm">
          {target}
        </span>
      </div>
